...
class _BuildNotificationCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String subtitle(String? val) {
      switch (val) {
        case 'waiting':
          return AppLocalizations.of(context)!.your_package_has_been_placedwe_are_waiting_for_payment_to_continue_the_next_process;
        case 'packaging':
          return AppLocalizations.of(context)!.hooray_your_package_is_being_packed_please_wait_for_the_seller_to_deliver_your_package;
        case 'on_delivery':
          return AppLocalizations.of(context)!.the_package_is_on_its_way_please_wait_until_your_package_arrives_at_your_home;
        case 'done':
          return AppLocalizations.of(context)!.the_package_has_arrived_at_your_house_immediately_confirm_your_order;
        case 'rating':
          return AppLocalizations.of(context)!.thank_you_for_shopping_give_an_assessment_to_help_us_keep_growing_and_getting_better;
        default:
        return '';
      }
    }
