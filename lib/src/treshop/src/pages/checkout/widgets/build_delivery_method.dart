    ...
    return Column(
        ...
        children: [
          _BuildLabelSection(
            ...
            onViewAllTap: () => Get.toNamed<dynamic>(TreshopRoutes.shipping),
          ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AutoSizeText(
                        ...
                        '${AppLocalizations.of(context)!.estimated} ${ShippingList.shippingList[1].estimate!} ${AppLocalizations.of(context)!.days}',
