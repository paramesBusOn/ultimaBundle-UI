...
class TreshopOrderDetailScreen extends StatelessWidget {
  const TreshopOrderDetailScreen({Key? key}) : super(key: key);
  @override
          ...
          Row(
            ...
            children: [
              ...
              CustomTextButton(
                ...
                onTap: () => Get.toNamed<dynamic>(TreshopRoutes.trackingOrder),
