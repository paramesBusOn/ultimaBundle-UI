...
import 'package:ultimate_bundle/src/foodiy/src/pages/order/in_progress/in_progress_tab.dart';
import 'package:ultimate_bundle/src/foodiy/src/pages/order/past_order/past_order_tab.dart'; 

class FoodiyOrderScreen extends StatefulWidget {
  const FoodiyOrderScreen({Key? key}) : super(key: key);
  @override
  _FoodiyOrderScreenState createState() => _FoodiyOrderScreenState();
}

class _FoodiyOrderScreenState extends State<FoodiyOrderScreen>
