...
class CustomColor {
  static const Color blueberry = Color(0xFF3F4098);
  static const Color chambray = Color(0xFF384984);
  static const Color dark = Color(0xFF192038);
  static const Color darkOrange = Color(0xFFFF8900);
  static const Color oysterBay = Color(0xFFDFF9FB);
  static const Color radicalRed = Color(0xFFFF3D71);
  static const Color rhino = Color(0xFF30336B);
  static const Color salmonPink = Color(0xFFFF7979);
  static const Color topaz = Color(0xFF17B7BD);
  static const Color ultraMarineBlue = Color(0xFF3366FF);
}
